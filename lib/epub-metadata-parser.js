          ...
          parser
            .parseString(data, function (err, result) {
              try {
                ...
                var manifest = convArr(jsondata.package.manifest);
                var nav = _.filter(manifest.item, (i) => i["$"].properties === "nav");
                Book.navLink = nav[0]["$"].href;
              ...
              try {
                ...
                if (typeof book["dc:identifier"] !== "undefined") 
                  Book.identifier = typeof book["dc:identifier"][0] === "object"
                    ? book["dc:identifier"][0]._
                    : book["dc:identifier"][0];
